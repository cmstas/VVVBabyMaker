...
echo linking... bkg
rm -f *.root
ln -sf $(ls ../../merged/*.root | grep -v data | grep -v www_ | grep -v ${VHTOSKIPPATTERN} | grep -v ${WGTOSKIP}) .
cd ..
cd bkgdata
...
ln -sf $(ls ../../merged/*.root | grep -v www_ | grep -v ${VHTOSKIPPATTERN} | grep -v ${WGTOSKIP} | grep -v wjets_incl) .
cd ..
cd bkgnonvbsttw
...
ln -sf $(ls ../../merged/*.root | grep vh | grep -v ${VHTOSKIPPATTERN}) .
cd ..
cd sigofficial
